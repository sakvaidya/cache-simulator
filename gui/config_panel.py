...
class ConfigPanel(tk.Frame):
    ...
    def _build(self):
        ...
        self.policy_combo = ttk.Combobox(
            ...
            values=["RAND", "LRU", "FIFO"],
            width=7,
            state="readonly",
        )
        self.policy_combo.pack(side=tk.RIGHT)
...
class ClockPanel(tk.Frame):
    ...
    def _build(self):
        ...
        for text, value in [("Single Step", "single"), ("Run to Completion", "run")]:
            tk.Radiobutton(self, text=text, variable=self.mode_var, value=value,
